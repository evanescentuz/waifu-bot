...
async def help(update: Update, context: CallbackContext) -> None:
    ...
    **━━━━━━━ᴄᴏᴍᴍᴀɴᴅꜱ━━━━━━━**
    ...
    ⎆ `/status` : ᴛᴏ ꜱʜᴏᴡ ʏᴏᴜʀ ᴘʀᴏꜰɪʟᴇ ᴡᴀɪꜰᴜ ɢʀᴀʙʙɪɴɢ ꜱᴛᴀᴛᴜꜱ 
    ⎆ `/bonus` : ᴛᴏ ɢᴇᴛ ʙᴏɴᴜꜱ ᴡᴀɪꜰᴜ ᴅᴀɪʟʏ
    ⎆ `/chlist` : ᴛᴏ ꜱʜᴏᴡ ᴀʟʟ ᴄʜᴀʀᴀᴄᴛᴇʀꜱ ʟɪꜱᴛ 
    ⎆ `/wfind` : ᴛᴏ ꜰɪɴᴅ ᴡᴀɪꜰᴜ ʙʏ ɪᴅ
    ⎆ `/cfind` : ᴛᴏ ꜰɪɴᴅ ᴡᴀɪꜰᴜ ʙʏ ᴀɴɪᴍᴇ
    **━━━━━━━ᴄᴏᴍᴍᴀɴᴅꜱ━━━━━━━**
    """
