...
rarity_map = 1 (⚪️ Common), 2 (🟣 Rare) , 3 (🟢 Medium), 4 (🟡 Legendary), 5 (🔮 Limited Edition), 6 (💮 Special), 7 (🎐 Celestial)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟢 Medium", 4: "🟡 Legendary", 5: "🔮 Limited Edition", 6: "💮 Special", 7: "🎐 Celestial"}
        try:
