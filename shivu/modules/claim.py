...
@bot.on_message(filters.command(["wfind"]))
async def wfind(_, message: t.Message):
    if len(message.command) < 2:
        return await message.reply_text("🔖ᴘʟᴇᴀꜱᴇ ᴡʀɪᴛᴇ ᴡᴀɪꜰᴜ ɪᴅ ᴛᴏᴏ", quote=True)
    ...
    caption = (
        ...
        f"◈𝗜𝗗: {waifu['id']}\n"
        f"┗━━━━━━━━━━━━━⧫\n\n"
        f"✳️ ʜᴇʀᴇ ɪꜱ ᴛʜᴇ ʟɪꜱᴛ ᴏꜰ ᴜꜱᴇʀꜱ ᴡʜᴏ ʜᴀᴠᴇ ᴡᴀɪꜰᴜꜱ:\n"
    )
